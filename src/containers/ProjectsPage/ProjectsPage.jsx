  ...
  return (
    <section className={styles.projectsPage}>
      ...
      <div className={styles.experience}>
        ...
        <br></br>
        <p>Exposure and working knowledge of TypeScript, Node.js, Express.js, Material UI, React-Chart-JS2 , Agile workflow (Kanban and Scrum), and Test-Driven Development.</p>
